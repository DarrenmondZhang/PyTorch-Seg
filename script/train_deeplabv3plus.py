...
from model.deeplab_model.lr_scheduler import LR_Scheduler
...
if __name__ == "__main__":
    ...
    BATCH_SIZE = 2
    NUM_WORKERS = 4
    warm_start, last_checkpoint_path = False, 'checkpoint/deeplabv3plus_%s_%s_v2_seed%s/best.pth.tar'%(MODEL, IMG_SIZE, SEED)
    checkpoint_path = 'checkpoint/deeplabv3plus_%s_%s_v1_seed%s'%(MODEL, IMG_SIZE, SEED)
    LOG_PATH = 'logging/deeplabv3plus_%s_%s_v1_seed%s.log'%(MODEL, IMG_SIZE, SEED)#
